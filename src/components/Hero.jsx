export default function Hero() {
  return <header className="hero" id="hero">
    ...
    <div className="hero__inner">
      ...
      <div className="hero__meta"><p className="hero__date">FREDAG 11 JUNI</p><p className="hero__date">LÖRDAG 12 JUNI 2027</p><p className="hero__place">Svärdsjö kyrka · Bergalid, Falun</p></div>
