...
const markLoaded = (event) => event.currentTarget.classList.add('is-loaded');
...
export default function Gallery() {
  ...
  const allPhotos = drivePhotos.map((photo) => ({ src: photo.url, lightboxSrc: toLightboxUrl(photo.url), alt: photo.name }));
